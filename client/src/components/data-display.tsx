  ...
  const handleDownload = () => {
    const csvContent = [
      ...
      ...data.map((item) => [
        ...
        (item.best_k ?? item.best_k_value)?.toString() || "N/A",
        item.country,
        item.market,
      ]),
    ]
                ...
                <TableBody>
                  {currentData.map((item, index) => (
                    ...
                    >
                      ...
                      <TableCell className="text-right text-slate-300">
                        {item.week_52_high
                          ? formatPrice(item.week_52_high, item.country)
                          : "N/A"}
                      </TableCell>
                      <TableCell className="text-right text-slate-300">
                        {item.week_52_low
                          ? formatPrice(item.week_52_low, item.country)
                          : "N/A"}
                      </TableCell>
                      <TableCell className="text-right text-slate-300">
